...
Route::group(['middleware' => 'auth'], function () {
	...
	Route::post('profile/{id}/add-relative', 'UserController@postAddRelative');
	Route::get('profile/{id}/delete', 'UserController@postDeleteRelative');
   ...
   //Ch?c v?
	...
	//Noti
	Route::post('sendnoti', 'NotiController@postNoti');
	Route::get('detail/{id}', 'NotiController@detail');

	Route::get('test', 'NotiController@test');

	Route::post('readMessage', 'NotiController@readMessage');
	Route::post('countMessage', 'NotiController@countMessage');
	Route::post('createRoom', 'NotiController@createRoom');
	Route::post('getNoti', 'NotiController@getNoti');
});
