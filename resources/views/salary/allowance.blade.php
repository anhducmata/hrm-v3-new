	                                ...
	                                <tbody>
	                                 <?php foreach ($allowances as $key => $allowance) {  ?>
		                                <tr>
	                                		...
	                                		<!-- <td><a  class="btn btn-warning btn_update" id="">Chỉnh sửa</a><a class="btn btn-primary" data-toggle="modal" style="margin-left: 10px" href='#modal-delete'>Xóa</a></td> -->
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('.btn_update').click(function(){
			var id= $(this).attr('id');
			$modal = $('#edit');
	        $modal.load("allowance/update/" + id);
	        $modal.modal('show');
		});
	});
</script>
