                            ...
                            <div class="form-horizontal form-seperated">
                                <div class="form-body">
                                	<div class="row">
	                                    ...
	                                    <div class="col-md-6">
	                                    	<div class="form-group">
		                                    	<label for="inputFirstName" class="col-md-4 control-label"> Số Người Thân<span class='require'>*</span> </label>

		                                        <div class="col-md-8"><input type="text" placeholder="Nhập Số Người Thân" class="form-control" name="number_relatives" value="{{$user->EmployeeRelative['number_relatives']}}"/></div>
		                                    </div>
	                                    </div>
                                    </div>
                                </div>
