                        ...
                        <div class="col-md-9">
                            <div class="tab-content">
                                ...
                                <div id="tab-emergency-setting" class="tab-pane fade">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-4">
                                            <button type="button" data-target="#modal-emergency" data-toggle="modal" class="btn btn-green">Thêm</button>
                                        </div>
                                    </div>
...
<!--Modal emergency-->
<div id="modal-emergency" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true"
     class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" data-dismiss="modal" aria-hidden="true"
                        class="close">&times;</button>
                <h4 id="modal-login-label" class="modal-title">Thêm người thân</h4></div>
            <div class="modal-body">
                <div class="form">
                    <form class="form-horizontal" method="post" action="profile/{{Auth::user()->id}}/add-relative">
                        {{csrf_field()}}
                        <div class="form-group">
                            <label for="username" class="control-label col-md-3">Họ Tên</label>
                        ...
                        <div class="form-group">
                            <label for="username" class="control-label col-md-3">Địa Chỉ</label>
                        ...
                        <div class="form-group">
                            <label for="username" class="control-label col-md-3">Mối Quan Hệ</label>
                        ...
                        <div class="form-group">
                            <label for="username" class="control-label col-md-3">Phụ Thuộc</label>
                        ...
                        <div class="form-group">
                            <label for="username" class="control-label col-md-3">Số Điện Thoại</label>
