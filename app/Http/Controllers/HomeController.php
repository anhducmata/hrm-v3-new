...
class HomeController extends Controller
{
    ...
    public static function SystemFetch(){
        ...
        if(Request::ajax()) {
            if(isset($_POST["view"])){
                ...
                $result = NotiUser::where('user_id',Auth::user()->id)->limit(5)->get()->reverse();
                    ...
                    foreach ($result as $key => $rs) {
                        ...
                        switch ($rs_noti->type) {
                            case 'KT':
                                ...
                                $content = 'Thông Báo: '.$rs_noti->title;
                                break;
    ...
    public static function createNoti($rec_list, $type, $content, $title){
